...
export function Modal({ open, onClose, title, children }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-end sm:items-center justify-center">
      ...
      />
      {/* Content */}
      <div className="relative w-full sm:max-w-md mx-0 sm:mx-4 md:mx-auto  bg-white rounded-3xl sm:rounded-3xl p-7 animate-[slideUp_0.3s_ease-out] max-h-[500px] overflow-y-auto">
