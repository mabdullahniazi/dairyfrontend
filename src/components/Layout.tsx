...
export function Layout() {
  ...
  return (
    <>
      ...
      <div className="relative z-10 min-h-screen flex flex-col md:ml-56">
        {/* Offline Banner */}
        {!isOnline && (
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-stone-400 font-medium hidden sm:block">Livestock Manager</p>
              </div>
            </div>
        ...
        <nav className="fixed bottom-0 left-0 right-0 md:hidden glass-card border-t border-white/10 z-30 safe-area-pb">
        ...
        {/* Desktop Sidebar Nav */}
        <nav className="hidden md:flex fixed left-0 top-0 bottom-0 w-56 flex-col glass-card border-r border-white/10 z-20 pt-20">
